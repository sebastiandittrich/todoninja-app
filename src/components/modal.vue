<template>
    <transition name="modal">
        <div v-show="show">
            <div class="h-full w-full bg-black opacity-50 absolute inset-0 dimmer cursor-pointer select-none" @click="$emit('hide')"></div>
            <div class="bg-white rounded-t-xl absolute bottom-0 inset-x-0 content" style="max-width: 90%">
